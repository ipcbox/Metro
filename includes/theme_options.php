...
//图片墙设置
    array(  "type" => "close"),
    array( "name" => "是否开启图片墙设置",
           "type" => "section"),
    array( "type" => "open"),

	array(  "name" => "是否开启图片墙",
			"desc" => "默认不开启",
            "id" => $shortname."_photos",
            "type" => "select",
            "std" => "Display",
            "options" => array("Hide", "Display")),
//QQ邮件订阅设置开始
    ...
    array( "type" => "open"),
	array(	"name" => "QQ邮件订阅",
            "desc" => "输入你的QQ邮件订阅ID，一般不超过100个字符",
            "id" => $shortname."_emaillist",
            "type" => "textarea",
            "std" => "739582c152df75660e1883cff8c3f054c1f53487052db118"),
...
add_theme_page($themename." 选项", "当前主题设置", 'edit_themes', basename(__FILE__), 'mytheme_admin');
}
